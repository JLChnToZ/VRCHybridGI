...
public class UnlitParticlesShaderEditorGUI : ShaderGUI {
    ...
    readonly MaterialProperty[] filteredProperties = new MaterialProperty[1];

    public UnlitParticlesShaderEditorGUI() {
    ...
    public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties) {
        ...
        foreach (var p in properties) {
            if (p == null) continue;
            switch (p.name) {
                case "_VRCLV": filteredProperties[0] = p; break;
            }
        }
